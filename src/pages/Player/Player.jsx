...
const Player = () => {
    ...
    const [loading, setLoading] = useState(true);     // carga perfil
    const [saving, setSaving] = useState(false);      // guardar perfil
    const [uploading, setUploading] = useState(false); // subir imagen
    ...
    }, [token, navigate, logout, API_URL, updateUserProfile]);
